...
def fastrcnn_loss(class_logits, box_regression, labels, regression_targets):
    ...
    box_loss = box_loss / (labels.numel()+0.00000000001)
    ...
    def forward(self,
        ...
        if self.nos_head is not None:
            if self.training:
                ...
                nos_proposals = [p["boxes"] for p in targets]
            ...
            if self.training:
                ...
                num_images = len(nos_predict)
                for i in range(num_images):
                    nos_per_img = nos_predict[i]
                    result.append(
                        {
                            "nos": nos_per_img.squeeze_(-1),
                        }
                    )
